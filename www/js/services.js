angular.module('app.services', [])
  ...
  .factory("data", function ($firebaseArray) {
    ...
    return {
      "2": $firebaseArray(fire.child("textures")),
      "3": $firebaseArray(fire.child("designs")),
      "4": $firebaseArray(fire.child("colors")),
      "5": $firebaseArray(fire.child("handles")),
      "6": $firebaseArray(fire.child("hinges"))
    }
  })
    ...
    this.set = function (id, value) {
      switch (id) {
        ...
        case "2":
          ...
          $rootScope.textureUrl = value.url;
          break;
        case "3":
          _designs.value       = value;
          $rootScope.designUrl = value.url;
          break;
        case "4":
          _colors.value = value;
          break;
